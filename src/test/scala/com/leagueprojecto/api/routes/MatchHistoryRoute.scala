...
//  val validChampionId = 25
//  val validLane = "MID"
//  val validRole = "SOLO"
//
//  val validParticipantStats = ParticipantStats(10, 5, 3, 2)
//  val validTimeLine = TimeLine(validRole, validLane)
//  val validParticipantsIdentities = Seq(ParticipantIdentity(Player(validSummonerId, "Minikoen")), ParticipantIdentity(Player(validSummonerId, "Waggles")))
//
//  val validParticipants = Seq(Participant(validSummonerId, validChampionId, validTimeLine, validParticipantStats), Participant(validSummonerId, validChampionId, validTimeLine, validParticipantStats))
//  val validMatchVersion = "6.3.0.240"
//  val validTeams = Seq(Team(100), Team(200))
//  val validHistory =
//    RiotMatch(12312312L, "RANKED_SOLO_5x5", 1600, 1432328493438L, validParticipantsIdentities, validParticipants,
//      validMatchVersion, validTeams)
...
//
//      responseAs[Seq[RiotMatch]] shouldBe validHistoryList
//    }
//  }
//
